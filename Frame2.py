...
class Frame2(Frame, Share):
    ...
    def inputs_cell(self):
        ...
        self.input_cell.grid(row=2+self.dfty, columnspan=1, column=2+self.dftx, padx=Share.window_width/4+15,
                             sticky="w")

    def outputs_cell(self):
        self.output_cell = Entry(self, self.output_cell, font='Arial 28')
        self.output_cell.grid(row=2+self.dfty, columnspan=1, column=3+self.dftx, padx=Share.window_width/4-10,
                              sticky="w")
